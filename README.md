...
* **src/power-analysis-code**: Code used to conduct power analyses for placing ads
* **src/ad-generation**: Code used to generate ads for our study
* **src/ad-results-analysis-code/analysis-10.2018.R**: R code used to estimate results, create figures, and create the data file used to generate the report
* **data/ad-placement-guides** guides for placing ads on Facebook and Google to conduct our study
* **data/ad-results**: data recorded by our ad posters, and used by the analysis code to generate the result. For a codebook, please contact the authors.
...
* [Austin Hounsel](https://www.cs.princeton.edu/~ahounsel/) is a computer science Ph.D. student at Princeton University and the Center for Information Technology Policy. He studies Internet performance, privacy, and censorship.
